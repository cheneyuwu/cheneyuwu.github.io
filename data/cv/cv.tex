...
\begin{rSection}{EMPLOYMENT HISTORY}
  \item \textbf{Nuro}, Toronto, Canada  \hfill {November 2022 - Present}\\
  Software Engineer\\
  Working on autonomous vehicle software for localization, mapping and sensor calibration.

  \item \textbf{Intel Corporation}, Toronto, Canada  \hfill {May 2018 - May 2019}\\
  Software Engineer Intern\\
  Worked on \textit{Intel HLS Compiler} and \textit{Intel FPGA SDK for OpenCL}
  \vspace{-0.5em}
...
\begin{rSection}{PUBLICATIONS}
  ...
  % \textit{IEEE International Conference on Robotics and Automation (ICRA)}, 2023
